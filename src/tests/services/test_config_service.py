...
class TestConfigService(unittest.TestCase):
    ...
    def test_openweather_url(self):
        self.assertEqual(self.config_service.open_weather_url, "https://api.openweathermap.org/data/2.5/weather?")

    def test_geocoding_url(self):
        self.assertEqual(self.config_service.geocoding_url, "http://api.openweathermap.org/geo/1.0/direct?")
